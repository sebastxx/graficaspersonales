...
//
    ...
    if($('#contact-form').length) {
        ...
        var contact_form_bValid, user_name_bValid,user_email_bValid,user_user_phone_bValid, user_email_message_bValid;
